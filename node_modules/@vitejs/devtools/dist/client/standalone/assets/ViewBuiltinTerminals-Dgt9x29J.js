...
`,t)}paste(e){this._core.paste(e)}refresh(e,t){this._verifyIntegers(e,t),this._core.refresh(e,t)}reset(){this._core.reset()}clearTextureAtlas(){this._core.clearTextureAtlas()}loadAddon(e){this._addonManager.loadAddon(this,e)}static get strings(){return{get promptLabel(){return de.get()},set promptLabel(e){de.set(e)},get tooMuchOutput(){return pe.get()},set tooMuchOutput(e){pe.set(e)}}}_verifyIntegers(...e){for(tc of e)if(tc===1/0||isNaN(tc)||tc%1!=0)throw Error(`This API only accepts integers`)}_verifyPositiveIntegers(...e){for(tc of e)if(tc&&(tc===1/0||isNaN(tc)||tc%1!=0||tc<0))throw Error(`This API only accepts positive integers`)}},rc=t({__name:`ViewBuiltinTerminalPanel`,props:{context:{},terminal:{}},setup(t){let n=t,r=p(),a;return s(async()=>{a=i(new nc({convertEol:!0,cols:80,screenReaderMode:!0}));let t=new v;if(a.loadAddon(t),a.open(r.value),t.fit(),u([()=>n.context.panel.store.width,()=>n.context.panel.store.height],()=>{e(()=>{t.fit()})}),h(window,`resize`,()=>{t.fit()}),e(()=>{t.fit()}),n.terminal.terminal=a,n.terminal.buffer==null){let{buffer:e}=await n.context.rpc.call(`devtoolskit:internal:terminals:read`,n.terminal.info.id);n.terminal.buffer=i(e)}for(let e of n.terminal.buffer)a.writeln(e)}),c(()=>{a.dispose(),n.terminal.terminal=null}),(e,t)=>(l(),te(`div`,{ref_key:`container`,ref:r,class:`h-full w-full of-auto bg-black`},null,512))}}),ic={class:`w-full h-full grid grid-rows-[max-content_1fr]`},ac={class:`border-base border-b rounded-t overflow-x-auto`},oc=[`onClick`],sc={class:`h-full w-full flex relative`},cc={key:1,class:`flex items-center justify-center h-full w-full text-center`},lc=t({__name:`ViewBuiltinTerminals`,props:{context:{}},setup(e){let t=oe(e.context),i=r(null);return _(t,()=>{i.value==null&&t.size>0&&(i.value=t.values().next().value)}),(r,s)=>(l(),te(`div`,ic,[ne(`div`,ac,[(l(!0),te(re,null,a(o(t).values(),e=>(l(),te(`button`,{key:e.info.id,class:ee([`px3 py1.5 border-r border-base hover:bg-active text-sm flex items-center gap-1`,{"bg-active":i.value?.info.id===e.info.id}]),onClick:t=>i.value=e},[n(g,{icon:e.info.icon||`ph:terminal-duotone`,class:`w-4 h-4`},null,8,[`icon`]),ne(`span`,null,m(e.info.title),1)],10,oc))),128))]),ne(`div`,sc,[i.value?(l(),d(rc,{key:i.value.info.id,context:e.context,terminal:i.value},null,8,[`context`,`terminal`])):(l(),te(`div`,cc,[...s[0]||=[ne(`div`,null,`Select a terminal tab to start`,-1)]]))])]))}});export{lc as default};