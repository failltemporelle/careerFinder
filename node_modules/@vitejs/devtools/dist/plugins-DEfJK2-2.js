import { t as DevToolsServer } from "./server-RXdxZpzz.js";
...
function DevToolsBuild(options = {}) {
	...
	return {
		...
		async buildStart() {
			const { createDevToolsContext } = await import("./server-RXdxZpzz.js").then((n) => n.r);
