import { computed, customRef, getCurrentInstance, getCurrentScope, hasInjectionContext, inject, isRef, markRaw, nextTick, onMounted, onScopeDispose, reactive, readonly, ref, shallowReadonly, shallowRef, toRaw, toRef, toRefs, toValue, unref, watch, watchEffect } from "vue";
...
let loadDockStandalone = async () => {
	return await import("./DockStandalone-IuqZ7neK.js").then((n) => n.n).then((m) => m.DockStandalone);
};
...
//#endregion
export { useDark as A, watchImmediate as B, createDockEntryState as C, BUILTIN_ENTRY_CLIENT_AUTH_NOTICE as D, BUILTIN_ENTRIES as E, useScreenSafeArea as F, useTimeAgo as I, useWindowSize as L, useElementBounding as M, useEventListener as N, onClickOutside as O, useLocalStorage as P, useDebounceFn as R, DEFAULT_DOCK_PANEL_STORE as S, useDocksEntries as T, whenever as V, KNOWN_BROWSER_SHORTCUTS as _, triggerMainFrameDockAction as a, isMac as b, setDocksOverflowPanel as c, useDockContextMenu as d, useDocksOverflowPanel as f, docksSplitGroupsWithCapacity as g, docksGroupByCategories as h, requestDockPopupOpen as i, useDraggable as j, useClipboard as k, setEdgePositionDropdown as l, useFloatingTooltip as m, isDockPopupSupported as n, useIsDockPopupOpen as o, useEdgePositionDropdown as p, registerMainFrameDockActionHandler as r, setDockContextMenu as s, closeDockPopup as t, setFloatingTooltip as u, collectAllKeybindings as v, sharedStateToRef as w, normalizeKeyEvent as x, formatKeybinding as y, watchDebounced as z };
