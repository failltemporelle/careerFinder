import { A as useDark, I as useTimeAgo, N as useEventListener, O as onClickOutside, R as useDebounceFn, _ as KNOWN_BROWSER_SHORTCUTS, b as isMac, c as setDocksOverflowPanel, d as useDockContextMenu, f as useDocksOverflowPanel, h as docksGroupByCategories, i as requestDockPopupOpen, j as useDraggable, l as setEdgePositionDropdown, m as useFloatingTooltip, n as isDockPopupSupported, o as useIsDockPopupOpen, p as useEdgePositionDropdown, s as setDockContextMenu, u as setFloatingTooltip, w as sharedStateToRef, y as formatKeybinding } from "./popup-Ba7Ij1xs.js";
import { t as getIconifySvg } from "./iconify-BtGUb4y8.js";
import { DEFAULT_STATE_USER_SETTINGS, REMOTE_CONNECTION_KEY } from "@vitejs/devtools-kit/constants";
import { Fragment, Suspense, TransitionGroup, computed, createBlock, createCommentVNode, createElementBlock, createElementVNode, createStaticVNode, createTextVNode, createVNode, defineAsyncComponent, defineComponent, defineCustomElement, h, markRaw, nextTick, normalizeClass, normalizeStyle, onMounted, onUnmounted, openBlock, reactive, ref, renderList, renderSlot, toDisplayString, toRefs, unref, useTemplateRef, vModelText, watch, watchEffect, withCtx, withDirectives, withKeys, withModifiers } from "vue";
...
const _hoisted_2$15 = ["fill"];
const _hoisted_3$12 = ["fill"];
...
const _sfc_main$25 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("svg", _hoisted_1$20, [
...
const _sfc_main$24 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			}, null, 8, _hoisted_1$19)) : (openBlock(), createElementBlock("img", {
				key: 1,
				src: __props.icon,
...
var VitePlusCore_default = /* @__PURE__ */ export_helper_default(_sfc_main$23, [["render", _sfc_render$1]]);
//#endregion
//#region src/client/webcomponents/components/dock/DockIcon.vue
const _hoisted_1$17 = { key: 1 };
const _sfc_main$22 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return icon.value.light === "builtin:vite-plus-core" ? (openBlock(), createBlock(VitePlusCore_default, { key: 0 })) : (openBlock(), createElementBlock("div", _hoisted_1$17, [icon.value.light === icon.value.dark ? (openBlock(), createBlock(_sfc_main$24, {
				key: 0,
				icon: icon.value.light,
				title: __props.title
			}, null, 8, ["icon", "title"])) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createVNode(_sfc_main$24, {
				class: "dark-hidden",
				icon: icon.value.light,
				title: __props.title
			}, null, 8, ["icon", "title"]), createVNode(_sfc_main$24, {
				class: "light-hidden",
...
const _hoisted_1$16 = { class: "flex items-center gap-0.5" };
const _sfc_main$21 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("span", _hoisted_1$16, [(openBlock(true), createElementBlock(Fragment, null, renderList(keys.value, (key, j) => {
...
const _hoisted_2$13 = { class: "flex items-center gap-2 flex-1 of-hidden min-w-0" };
const _hoisted_3$11 = { class: "flex-1 min-w-0" };
const _hoisted_4$8 = { class: "flex items-center gap-1.5" };
const _hoisted_5$8 = { class: "truncate" };
const _hoisted_6$7 = {
	key: 0,
	class: "op50"
};
...
const _sfc_main$20 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			...
			}, [createElementVNode("div", { class: normalizeClass(["flex items-center gap-2 justify-between rounded-md px-2.5 py-1.5 text-sm transition-colors", __props.selected ? "bg-primary/10 text-primary" : "op80 hover:op100"]) }, [createElementVNode("div", _hoisted_2$13, [__props.entry.icon ? (openBlock(), createBlock(_sfc_main$22, {
				key: 0,
				icon: __props.entry.icon,
				class: "w-4 h-4 flex-none op70"
			}, null, 8, ["icon"])) : createCommentVNode("v-if", true), createElementVNode("div", _hoisted_3$11, [createElementVNode("div", _hoisted_4$8, [createElementVNode("span", _hoisted_5$8, [__props.parentTitle && __props.showParentTitle ? (openBlock(), createElementBlock("span", _hoisted_6$7, toDisplayString(__props.parentTitle) + " › ", 1)) : createCommentVNode("v-if", true), createTextVNode(" " + toDisplayString(__props.entry.title), 1)]), __props.entry.source === "server" ? (openBlock(), createElementBlock("span", _hoisted_7$4, "server")) : createCommentVNode("v-if", true)]), __props.selected && __props.entry.description ? (openBlock(), createElementBlock("div", _hoisted_8$3, toDisplayString(__props.entry.description), 1)) : createCommentVNode("v-if", true)])]), createElementVNode("div", _hoisted_9$3, [
...
const _hoisted_1$14 = { class: "absolute inset-0 flex items-start justify-center relative pt-[20vh] pointer-events-none" };
const _hoisted_2$12 = { class: "w-full w-lg bg-base border border-base rounded-lg shadow-xl pointer-events-auto of-hidden flex flex-col max-h-[60vh]" };
const _hoisted_3$10 = { class: "border-b border-base flex items-center px-3" };
const _hoisted_4$7 = ["onClick"];
const _hoisted_5$7 = { class: "flex-1 of-y-auto p-1.5" };
const _hoisted_6$6 = {
	key: 0,
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return show.value ? (openBlock(), createElementBlock("div", {
				...
				createElementVNode("div", _hoisted_1$14, [createElementVNode("div", { class: normalizeClass(["flex flex-col transition-all duration-150", visible.value ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-98 -translate-y-2"]) }, [createVNode(_sfc_main$25, { class: "absolute top--32px left-5px w-60 pointer-events-none" }), createElementVNode("div", _hoisted_2$12, [
					createCommentVNode(" Header "),
					createElementVNode("header", _hoisted_3$10, [
						...
						breadcrumb.value.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(breadcrumb.value, (crumb, i) => {
							...
							}, [createTextVNode(toDisplayString(crumb.title) + " ", 1), _cache[1] || (_cache[1] = createElementVNode("span", { class: "op40" }, "›", -1))], 8, _hoisted_4$7);
					...
					createElementVNode("div", _hoisted_5$7, [(openBlock(true), createElementBlock(Fragment, null, renderList(filtered.value, (item, idx) => {
					...
					}), 128)), !filtered.value.length ? (openBlock(), createElementBlock("div", _hoisted_6$6, [_cache[4] || (_cache[4] = createElementVNode("div", { class: "i-ph-magnifying-glass-duotone w-6 h-6" }, null, -1)), search.value ? (openBlock(), createElementBlock("div", _hoisted_7$3, [
...
const _hoisted_1$13 = { class: "flex items-start gap-2 relative" };
const _hoisted_2$11 = {
	key: 0,
	class: "flex-none mt-0.5 border-2 border-current border-t-transparent rounded-full animate-spin op50 w-4 h-4"
};
const _hoisted_3$9 = { class: "flex-1 min-w-0 space-y-0.5" };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$13, [
				...
				__props.entry.status === "loading" ? (openBlock(), createElementBlock("div", _hoisted_2$11)) : (openBlock(), createElementBlock("div", {
					key: 1,
				...
				createElementVNode("div", _hoisted_3$9, [
					createElementVNode("div", _hoisted_4$6, [
						...
						}, toDisplayString(unref(timeAgo)), 9, _hoisted_5$6)) : createCommentVNode("v-if", true),
						renderSlot(_ctx.$slots, "actions")
					]),
					__props.entry.description ? (openBlock(), createElementBlock("div", _hoisted_6$5, toDisplayString(__props.entry.description), 1)) : createCommentVNode("v-if", true),
					!__props.compact ? (openBlock(), createElementBlock("div", _hoisted_7$2, [__props.entry.category ? (openBlock(), createBlock(_sfc_main$18, {
						key: 0,
				...
				return openBlock(), createElementBlock("div", {
					...
					createElementVNode("div", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(entries, (dock, index) => {
						return openBlock(), createElementBlock("div", {
							...
							dock.type === "action" ? (openBlock(), createBlock(_sfc_main$18, {
								key: 0,
								label: "Action",
			...
			return openBlock(), createElementBlock(Fragment, null, [
				...
				createElementVNode("div", _hoisted_2$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(filteredShortcutRows.value, (row) => {
					return openBlock(), createElementBlock("div", {
						...
						createCommentVNode(" Icon & Title "),
						row.command.icon ? (openBlock(), createBlock(_sfc_main$22, {
							key: 0,
						...
						createElementVNode("div", _hoisted_8, [
							getEffectiveKeybindings(row.command.id).length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(getEffectiveKeybindings(row.command.id), (kb, ki) => {
								...
								}, [createVNode(_sfc_main$21, { "key-string": kb.key }, null, 8, ["key-string"])], 8, _hoisted_9);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const ViewBuiltinTerminals = defineAsyncComponent(() => import("./ViewBuiltinTerminals-IUgrrBbH.js"));
		const ViewBuiltinMessages = defineAsyncComponent(() => import("./ViewBuiltinMessages-eNp17suy.js"));
		const ViewJsonRender = defineAsyncComponent(() => import("./ViewJsonRender-CI1Uv2LG.js"));
		return (_ctx, _cache) => {
...
//#endregion
export { css_default as S, useMessages as _, PersistedDomViewsManager as a, VitePlusCore_default as b, openDockContextMenu as c, _sfc_main$17 as d, _sfc_main$18 as f, markMessagesAsRead as g, levels as h, PersistedDomHolder as i, _sfc_main$15 as l, getHashColorFromString as m, DockStandalone_exports as n, _sfc_main$12 as o, fromEntries as p, _sfc_main$1 as r, _sfc_main$14 as s, DockStandalone as t, _sfc_main$16 as u, _sfc_main$19 as v, export_helper_default as x, _sfc_main$22 as y };
